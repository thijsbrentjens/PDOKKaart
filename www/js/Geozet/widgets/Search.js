...
Geozet.Search = OpenLayers.Class({
    ...
    initialize: function(config, map) {
        ...
        this.contentWrapperId = this.config['gazetteer'].contentWrapperId;
        
        Ext.get(this.contentWrapperId).on('submit', this.onSubmit, this, {delegate: 'form'});
    ...
    destroy: function() {
        ...
        Ext.get(this.contentWrapperId).un('submit', this.onSubmit, this, {delegate: 'form'});
        this.map=null;
        this.config=null;
